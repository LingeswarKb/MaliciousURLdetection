...
legitimate_df = pd.read_csv("E:/Downloads/phishing-website-detection-content-based-main/phishing-website-detection-content-based-main/structured_data_legitimate.csv")
phishing_df = pd.read_csv("E:/Downloads/phishing-website-detection-content-based-main/phishing-website-detection-content-based-main/structured_data_phishing.csv")
