...
URL_file_name = "phishing-website-detection-content-based-main/verified_online1.csv"
...
df.to_csv("structured_data_phishing1.csv", mode='a', index=False, header=False)  # header should be false after the first run
